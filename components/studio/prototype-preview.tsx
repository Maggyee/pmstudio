      ...
      <div className="flex flex-col gap-3 border-b border-neutral-200 px-4 py-3 md:flex-row md:items-center md:justify-between">
        <div className="min-w-0">
          ...
          <div className="mt-1 flex flex-wrap items-center gap-2">
            <h2 className="text-lg font-semibold text-neutral-950">AI 产品经理工作台变体 A</h2>
          ...
          <div className="min-w-0 overflow-hidden rounded-xl border border-zinc-800 bg-white text-zinc-950 shadow-2xl">
            <div className="flex items-center justify-between border-b border-zinc-200 bg-zinc-50 px-4 py-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-medium text-zinc-500">pmstudio.ai</span>
              </div>
            </div>
            ...
            <div className={cn("min-w-0 p-5", !isMobile && "sm:p-8")}>
              ...
              >
                <div>
                  ...
                  >
                    在一个工作区内生成产品定位、目标用户、PRD、页面结构、竞品方向和项目汇报摘要。
                  </p>
                ...
                <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-4">
                  <div className="mb-3 flex items-center justify-between">
                    <p className="text-sm font-semibold">产品方案交付物</p>
                    <span className="rounded-full bg-emerald-100 px-2 py-1 text-xs font-medium text-emerald-700">
                      5 份文件
                    </span>
                  </div>
                  <div className="space-y-2">
                    {["PRD.md", "Prototype.html", "Competitors.csv", "Executive-summary.pdf"].map(
                      (item) => (
                        <div
